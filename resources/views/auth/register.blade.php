...
<div class="container base-template">
	<div class="row">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" method="POST"
						...
						<div
							...
							<div class="col-md-6">
								<input type="password" class="form-control" name="password"> @if($errors->has('password')) <span class="help-block"> <strong>{{
						...
						<div
							...
							<div class="col-md-6">
								<input type="password" class="form-control"
									name="password_confirmation"> @if($errors->has('password_confirmation')) <span class="help-block">
