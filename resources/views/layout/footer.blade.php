			...
			<div class="jp-gui">
				...
				<div class="jp-interface">
					<div class="jp-controls">
						...
						<div>
							<a class="" title="Save current playlist" id="savePlaylist"
								data-value="{{Auth::id()}}"> <i class="fa fa-save"></i>
							</a>
						</div>
						<div>
							<a class="" title="Clear playlist" id="clearPlaylist"> <i
								class="icon-trash"></i>
							</a>
						</div>
						...
						<div>
							<a class="jp-repeat" title="repeat"> <i
								class="icon-loop text-muted"></i>
							</a> <a class="jp-repeat-off hid" title="repeat off"> <i
								class="icon-loop text-lt"></i>
							</a>
						</div>
						<div class="hide">
